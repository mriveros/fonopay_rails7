class UsuariosSessionsController < ApplicationController
  ...
  before_action :require_usuario, :only => :destroy
  ...
  def usuario_session_params
    ...
    params.require(:usuario_session).permit(:password)
  ...
  def create
    ...
    if persona.present?
      ...
      usuario_session_params_hash = usuario_session_params.to_h
      @usuario_session = UsuarioSession.new(usuario_session_params_hash)
