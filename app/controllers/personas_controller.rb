class PersonasController < ApplicationController
  ...
  def persona_params
    ...
    params.require(:persona).permit(:tipo_documento_id, :nacionalidad_id, :documento_persona, :fecha_inscripcion, :numero_oficina, :folio, :libro, :acta, :nombre_persona, :apellido_persona, :fecha_nacimiento, :direccion, :telefono, :celular, :correo_electronico, :genero_id)
